...
//     <div style={{ textAlign: "center",fontFamily:"Rubik", fontSize: "12px", fontWeight: "bold" ,color:'black'}}> {/* הקטנת פונט התוכן */}
//       <div>{event.title}</div>
//       <div style={{ fontSize: "10px", opacity: 0.8 }}> {/* הקטנת פונט הפרטים הנוספים */}
//         {event.extendedProps.secondTitle}<br/>
//         {event.extendedProps.lecturer}</div>
//     </div>
//   );
...
//           padding: "10px 15px", // הקטנת פדינג
//           borderBottom: "2px solid #ddd", // הקטנת עובי הגבול
//           fontFamily:"Rubik",
//           fontSize: '16px', // הקטנת פונט שעות
...
//         },
//         "& .fc-resource": { textAlign: "center", fontSize: '14px',fontFamily:"Rubik"}, // הקטנת פונט שמות החדרים
//         "& .fc-event": {
//           width:"100%",
//           borderRadius: "8px", // הקטנת עיגול פינות
//           padding: "3px", // הקטנת פדינג אירוע
//           fontSize: "12px", // הקטנת פונט אירוע
//           fontWeight: "bold",
//           textAlign: "center",
//           color: "#fff",
//           display: "flex",
